...
def CHAM128_128_ENC(eng, resource):
    ...
    for j in range(10):
        ...
        with Compute(eng):
            ...
            KeyGen64_type_8to15(eng, k1, key_temp1) #RK4
            KeyGen64_type_8to15(eng, k0, key_temp2) #RK5
        x0, x1, x2, x3 = Round_even(eng, x0, x1, x2, x3, k3, i, c0)
        i = i + 1
        x0, x1, x2, x3 = Round_odd(eng, x0, x1, x2, x3, k1, i, c1)
        i = i + 1
        x0, x1, x2, x3 = Round_even(eng, x0, x1, x2, x3, k0, i, c2)
        i = i + 1
        Uncompute(eng)

        with Compute(eng):
            KeyGen64_type_8to15(eng, k3, key_temp)  # RK10
            KeyGen64_type_8to15(eng, k2, key_temp1)  # RK11
        x0, x1, x2, x3 = Round_odd(eng, x0, x1, x2, x3, k3, i, c2)
        i = i + 1
        x0, x1, x2, x3 = Round_even(eng, x0, x1, x2, x3, k2, i, c1)
        i = i + 1
        Uncompute(eng)
...
CHAM128_128_ENC(eng, 0)

print('Estimate cost...')
Resource = ResourceCounter()
eng = MainEngine(Resource)
CHAM128_128_ENC(eng, 1)
print(Resource)
eng.flush()
