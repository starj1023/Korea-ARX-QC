...
def LEA128_Enc(eng):
    ...
    if(resource == 0):
        ...
        # Plaintext
        Round_constant_XOR(eng, x0, 0x13121110, 32)
        Round_constant_XOR(eng, x1, 0x17161514, 32)
        Round_constant_XOR(eng, x2, 0x1b1a1918, 32)
        Round_constant_XOR(eng, x3, 0x1f1e1d1c, 32)

    i = 0

    k0, k1, k2, k3 = KeySchedule(eng, k0, k1, k2, k3, theta0, theta1, theta2, theta3, c0, c1, c2, c3, i)
    i = i+1
    x0, x1, x2, x3 = Enc(eng, x0, x1, x2, x3, k0, k1, k2, k1, k3, k1, c0, c1)

    change_theta(eng, theta0, theta1, theta2, theta3, 0xc3efe9db, 0x44626b02)
    k0, k1, k2, k3 = KeySchedule(eng, k0, k1, k2, k3, theta0, theta1, theta2, theta3, c0, c1, c2, c3, i)
    i = i + 1
    x0, x1, x2, x3 = Enc(eng, x0, x1, x2, x3, k0, k1, k2, k1, k3, k1, c0, c1)

    change_theta(eng, theta0, theta1, theta2, theta3, 0x44626b02, 0x79e27c8a)
    k0, k1, k2, k3 = KeySchedule(eng, k0, k1, k2, k3, theta0, theta1, theta2, theta3, c0, c1, c2, c3, i)
    i = i + 1
    x0, x1, x2, x3 = Enc(eng, x0, x1, x2, x3, k0, k1, k2, k1, k3, k1, c0, c1)

    change_theta(eng, theta0, theta1, theta2, theta3, 0x79e27c8a, 0x78df30ec)
    k0, k1, k2, k3 = KeySchedule(eng, k0, k1, k2, k3, theta0, theta1, theta2, theta3, c0, c1, c2, c3, i)
    i = i + 1
    x0, x1, x2, x3 = Enc(eng, x0, x1, x2, x3, k0, k1, k2, k1, k3, k1, c0, c1)
    ...
    ##
    for j in range(5):
        change_theta(eng, theta0, theta1, theta2, theta3, 0x78df30ec, 0xc3efe9db)
        k0, k1, k2, k3 = KeySchedule(eng, k0, k1, k2, k3, theta0, theta1, theta2, theta3, c0, c1, c2, c3, i)
        i = i + 1
        x0, x1, x2, x3 = Enc(eng, x0, x1, x2, x3, k0, k1, k2, k1, k3, k1, c0, c1)
...
def Enc(eng, x0, x1, x2, x3, rk0, rk1, rk2, rk3, rk4, rk5, c0, c1):
...
def KeySchedule(eng, k0, k1, k2, k3, theta0, theta1, theta2, theta3, c0, c1, c2, c3, i):
...
def change_theta(eng, theta0, theta1, theta2, theta3, a, b):
    a = a^b
