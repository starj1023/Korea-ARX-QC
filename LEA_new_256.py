...
def LEA_256_Enc(eng):
    ...
    if (resource == 0):
        ...
        Round_constant_XOR(eng, k6, 0x4b5a6978, 32)
        Round_constant_XOR(eng, k7, 0x0f1e2d3c, 32)

        # Plaintext
        Round_constant_XOR(eng, x0, 0x33323130, 32)
        Round_constant_XOR(eng, x1, 0x37363534, 32)
        Round_constant_XOR(eng, x2, 0x3b3a3938, 32)
        Round_constant_XOR(eng, x3, 0x3f3e3d3c, 32)
    ...
    k6, k7, k0, k1, k2, k3 = KeySchedule(eng, k6, k7, k0, k1, k2, k3, theta0, theta1, theta2, theta3, theta4, theta5, c0, c1, c2, c3, c4, c5, i)
    i = i + 1
    x0, x1, x2, x3 = Enc(eng, x0, x1, x2, x3, k6, k7, k0, k1, k2, k3, c0)

    change_theta(eng, theta0, theta1, theta2, theta3, theta4, theta5, 0x44626b02, 0x79e27c8a)
    k4, k5, k6, k7, k0, k1 = KeySchedule(eng, k4, k5, k6, k7, k0, k1, theta0, theta1, theta2, theta3, theta4, theta5, c0, c1, c2, c3, c4, c5, i)
    i = i + 1
    x0, x1, x2, x3 = Enc(eng, x0, x1, x2, x3, k4, k5, k6, k7, k0, k1, c0)

    change_theta(eng, theta0, theta1, theta2, theta3, theta4, theta5, 0x79e27c8a, 0x78df30ec)
    k2, k3, k4, k5, k6, k7 = KeySchedule(eng, k2, k3, k4, k5, k6, k7, theta0, theta1, theta2, theta3, theta4, theta5, c0, c1, c2, c3, c4, c5, i)
    i = i + 1
    x0, x1, x2, x3 = Enc(eng, x0, x1, x2, x3, k2, k3, k4, k5, k6, k7, c0)
    ...
    change_theta(eng, theta0, theta1, theta2, theta3, theta4, theta5, 0xc785da0a, 0xe04ef22a)
    k4, k5, k6, k7, k0, k1 = KeySchedule(eng, k4, k5, k6, k7, k0, k1, theta0, theta1, theta2, theta3, theta4, theta5, c0, c1, c2, c3, c4, c5, i)
    i = i + 1
    x0, x1, x2, x3 = Enc(eng, x0, x1, x2, x3, k4, k5, k6, k7, k0, k1, c0)

    change_theta(eng, theta0, theta1, theta2, theta3, theta4, theta5, 0xe04ef22a, 0xe5c40957)
    k2, k3, k4, k5, k6, k7 = KeySchedule(eng, k2, k3, k4, k5, k6, k7, theta0, theta1, theta2, theta3, theta4, theta5, c0, c1, c2, c3, c4, c5, i)
    i = i + 1
    x0, x1, x2, x3 = Enc(eng, x0, x1, x2, x3, k2, k3, k4, k5, k6, k7, c0)
    ...
    ##
    for j in range(3):
        change_theta(eng, theta0, theta1, theta2, theta3, theta4, theta5, 0xe5c40957, 0xc3efe9db)
        k0, k1, k2, k3, k4, k5 = KeySchedule(eng, k0, k1, k2, k3, k4, k5, theta0, theta1, theta2, theta3, theta4, theta5, c0, c1, c2, c3, c4, c5, i)
        i = i + 1
        x0, x1, x2, x3 = Enc(eng, x0, x1, x2, x3, k0, k1, k2, k3, k4, k5, c0)
